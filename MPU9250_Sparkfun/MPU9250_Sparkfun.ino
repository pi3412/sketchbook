...
/* #ifdef LCD
    ...
    // temperature
    Serial.print("MPU9250 initialized for active data mode....\r\n");
...
/* #ifdef LCD
    ...
    Serial.print("AK8963 initialized for active data mode....\r\n");
    if (SerialDebug)
    {
      //  Serial.println("Calibration values: ");
      Serial.print("X-Axis sensitivity adjustment value ");
      Serial.print(myIMU.magCalibration[0], 2);
      Serial.print("\r\nY-Axis sensitivity adjustment value ");
      Serial.print(myIMU.magCalibration[1], 2);
      Serial.print("\r\nZ-Axis sensitivity adjustment value ");
      Serial.print(myIMU.magCalibration[2], 2);
      Serial.print("\r\n");
    }
...
/* #ifdef LCD
  ...
  {
    Serial.print("\r\nCould not connect to MPU9250: 0x");
    Serial.print(c, HEX);
